...
/*$sth = $conn->prepare("SELECT * FROM patrimoniopref WHERE npatrimonio = :npatrimonio");
...
if(empty($dados['nome'])){
    ...
    $query_ptr = "UPDATE patrimoniopref set nome=:nome, obs=:obs, modified=NOW() WHERE id=:id";
