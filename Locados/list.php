...
$query_patrimonios = "SELECT id, nserie, nome, created FROM naolocados ORDER BY created DESC LIMIT $inicio, $qnt_result_pg";
...
$query_pg = "SELECT COUNT(id) AS num_result FROM naolocados";
