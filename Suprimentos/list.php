...
$query_patrimonios = "SELECT id, nomesup, qtd FROM suprimentos ORDER BY nomesup DESC LIMIT $inicio, $qnt_result_pg";
...
$query_pg = "SELECT COUNT(id) AS num_result FROM suprimentos";
